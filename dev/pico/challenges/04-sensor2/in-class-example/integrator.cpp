...
int distanceToCounts(float distance){
    ...
    */
    ...
    float rotations = distance/(2*3.14WHEEL_RADIUS);
    //converts number of rotations to number of counts
    float counts_f = rotations*COUNTS_PER_ROATIONS;
